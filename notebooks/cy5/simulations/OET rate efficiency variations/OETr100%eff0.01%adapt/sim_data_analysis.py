...
def simulate_data(number_of_simulations, memory, threshold, transition_set, 
                  tcspc=False, memmap=False, long_sim=False):
    ...
    for i in range(number_of_simulations):
        if tcspc:
            ...
            _, _, fluorescence_lifetimes = emis.tcspc(transition_set=transition_set,
                                            number_pulses=1e7,  
                                            pulse_duration=1e-11,  # 10 ps 
                                            time_between_pulses=1e-7,  # 10 ns
                                            excitation_rates={'cy5_dna': 1.5e10}, # this is 1000x higher than 2.5kW/cm² produces, because 10 ns is 1000x 10ps. 
                                            size=1e5,
