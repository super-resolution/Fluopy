...
def universal_figure(width=10, height=5, type_="plot", data=(0, 0), color="blue", ylabel="y", xlabel="x", legend=None,
                     xlim=None, ylim=None, xscale=None, yscale=None, xticks=None, yticks=None, xticklabels=None,
                     yticklabels=None, tick_spacing_x=None, tick_spacing_y=None, tick_style_x=None,
    ...
    # data incorporation
    if type_ == "hist":
        ax.hist(x=data, color=color, **type_specific_kwargs)
    elif type_ == "bar":
        ax.bar(x=data[0], height=data[1], color=color, **type_specific_kwargs)
    elif type_ == "line":
        ax.plot(data[0], data[1], color=color, **type_specific_kwargs)
