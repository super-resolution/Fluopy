...
def simulate_TCSPC_detailed_rest(
    transition_set,
    emitting_transition_ids,
    et_transition_ids=None,
    number_pulses=1e5,
    ...
    while i < number_pulses:
        ...
        # remembered, the simulation continues from there
            ...
            if not not_broken:
                ...
                return transition_series, excitation_series, transition_set
            elif remember[1] != np.inf and not checked:
                skip = True
                next_transition = remember[0]
                time = remember[1]
...
def insert_excitations(transition_series, transition_set, excitation_series):
    ...
    # print(f'{excitation_series = }')
    # print(f'{indices_transitions = }')
    # print(f'{diffs = }')
    ...
    for i in range(number_fluorophores):
        ...
        # get the index of the last fluorophore that was excited and not already included
