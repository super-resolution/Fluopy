...
class FluorophoreSystem:
    ...
    """
    def __init__(self, number, distances, states, rates, predefined=None):
        """
        Parameters
        ----------
        number : int
        ...
        self.rates = rates
        if predefined:
            self.Joined_States, self.state_names, self.state_ids, self.transitions, self.assigned_rate_dict, \
                self.rate_name_dict, self.initial_row_vector, self.transition_matrix, self.row_sums = predefined
        else:
...
class GeneralModel(FluorophoreSystem):
    ...
    """
    def __init__(self, number, distances, rates, predefined=None):
        """
        Parameters
        ----------
        number : int
        ...
        """
        states = ("S0", "S1", "T1", "B")
        super().__init__(number, distances, states, rates, predefined)
    ...
    def emitters(self, photon_collection=1, resample="5ms", unit="s", emccd_gain=None, threshold=0, memory=0,
        ...
        self.pandas_series = et.pandas_event_time_series(self.events_at, unit, resample, emccd_gain)
...
class Cy5Model(GeneralModel):
    """
    Derived class from GeneralModel. States include the cis/trans isomers of the fluorophore Cy5.
    """
    def __init__(self, number, distances, rates, predefined=None):
        states = ("tS0", "tS1", "tT1", "cS0", "cS1", "B")
        super(GeneralModel, self).__init__(number, distances, states, rates, predefined)
        # sets the method resolution order __mro__ such that it starts from GeneralModel


class Cy5dSTORMModel(Cy5Model):
    """
    Derived class from Cy5Model. States include the dSTORM OFF state.
    """
    def __init__(self, number, distances, rates, predefined=None):
        states = ("tS0", "tS1", "tT1", "cS0", "cS1", "OFF", "B")
        super(GeneralModel, self).__init__(number, distances, states, rates, predefined)
...
class Cy5CisModel(GeneralModel):
    ...
    """
    def __init__(self, number, distances, rates, predefined=None):
        states = ("tS0", "tS1", "tT1", "Cis", "B")
        super(GeneralModel, self).__init__(number, distances, states, rates, predefined)
        # sets the method resolution order __mro__ such that it starts from GeneralModel


class Cy5CisdSTORMModel(Cy5CisModel):
    """
    Derived class from Cy5CisModel. States include the dSTORM OFF state.
    """
    def __init__(self, number, distances, rates, predefined=None):
        states = ("tS0", "tS1", "tT1", "Cis", "OFF", "B")
        super(GeneralModel, self).__init__(number, distances, states, rates, predefined)
